...
class CE_model(nn.Module):
    def __init__(self, args):
        super(CE_model, self).__init__()
        self.query_encoder = nn.Linear(args.input_dim, args.output_dim, bias=False)
        self.doc_encoder = nn.Linear(args.input_dim, args.output_dim, bias=False)
